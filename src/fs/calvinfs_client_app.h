...
*/    
  ...
  { // gaoxuan --删除文件的实验
    ...
    string from_path9 = from_path8 + "/d" + IntToString(a8);
    string from_path0 = from_path9 + "/e" + IntToString(a9);
    ...
    LOG(ERROR) << machine()->machine_id() << " path: " << from_path9 << " in " << config_->LookupMetadataShard(config_->HashFileName(from_path9), config_->LookupReplica(machine()->machine_id()));
    BackgroundLS(from_path9);
