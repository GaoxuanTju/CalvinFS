...
string from_path = "/a_0" + IntToString(machine()->machine_id())+"/a_1" + IntToString(0)+"/a_2" + IntToString(0)+"/a_3" + IntToString(0)+"/a_4" + IntToString(0)+"/a_5" + IntToString(0)+"/a_6" + IntToString(0)+"/a_7" + IntToString(0)+"/a_80";//+"/a_8" + IntToString(0)+"/a_9" + IntToString(0);   
