...
const ::google::protobuf::uint32 TableStruct_header_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::Header, long_prefix_),
  ...
  PROTOBUF_FIELD_OFFSET(::Header, original_from_),
...
const char descriptor_table_protodef_header_2eproto[] =
  ...
  "gth\030\016 \001(\007\022\031\n\021split_string_from\030\017 \003(\t\022\021\n\t"
  "to_length\030\020 \001(\007\022\027\n\017split_string_to\030\021 \003(\t"
  "\022\r\n\005depth\030\022 \001(\007\022\013\n\003uid\030\023 \001(\007\022\024\n\014metadate"
  "ntry\030\024 \003(\t\022\024\n\014callback_app\030\025 \001(\t\022\024\n\014call"
  "back_rpc\030\026 \001(\t\022\023\n\013ack_counter\030\027 \001(\006\022\023\n\013l"
  "ong_prefix\030\030 \001(\t\022\020\n\010data_ptr\030\037 \001(\006\022\024\n\014da"
  "ta_channel\030  \001(\t\022\021\n\tmisc_bool\030) \003(\010\022\020\n\010m"
  "isc_int\030* \003(\004\022\023\n\013misc_string\030+ \003(\014\022\023\n\013mi"
  "sc_double\030, \003(\001\022\034\n\013misc_scalar\030- \003(\0132\007.S"
  "calar\022\025\n\roriginal_from\030. \001(\004\022\025\n\rexternal"
  "_host\0303 \001(\t\022\025\n\rexternal_port\0304 \001(\005\"F\n\004Ty"
  ...
  "2\007.Action\022\"\n\014action_batch\030\004 \001(\0132\014.Action"
  "Batch\022%\n\rstartappproto\030\005 \001(\0132\016.StartAppP"
  "roto"
  ;
::google::protobuf::internal::DescriptorTable descriptor_table_header_2eproto = {
  ...
  "header.proto", &assign_descriptors_table_header_2eproto, 924,
};
...
class Header::HasBitSetters {
 public:
  ...
  static void set_has_long_prefix(Header* msg) {
  ...
  static void set_has_original_from(Header* msg) {
...
const int Header::kLongPrefixFieldNumber;
...
const int Header::kOriginalFromFieldNumber;
...
Header::Header(const Header& from)
  ...
  long_prefix_.UnsafeSetDefault(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
  if (from.has_long_prefix()) {
    long_prefix_.AssignWithDefault(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), from.long_prefix_);
  }
...
void Header::SharedCtor() {
  ...
  ::memset(&flag_, 0, static_cast<size_t>(
      reinterpret_cast<char*>(&original_from_) -
      reinterpret_cast<char*>(&flag_)) + sizeof(original_from_));
  type_ = 1;
  priority_ = 1;
}
...
void Header::SharedDtor() {
  ...
  long_prefix_.DestroyNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
...
// @@protoc_insertion_point(message_clear_start:Header)
  ...
  if (cached_has_bits & 0x0000007fu) {
    ...
    if (cached_has_bits & 0x00000010u) {
      long_prefix_.ClearNonDefaultToEmptyNoArena();
    }
  ...
  if (cached_has_bits & 0x0000ff00u) {
    ::memset(&from_, 0, static_cast<size_t>(
        ...
        reinterpret_cast<char*>(&from_)) + sizeof(external_port_));
  }
  if (cached_has_bits & 0x000f0000u) {
    ::memset(&data_ptr_, 0, static_cast<size_t>(
        reinterpret_cast<char*>(&original_from_) -
        reinterpret_cast<char*>(&data_ptr_)) + sizeof(original_from_));
    type_ = 1;
    priority_ = 1;
  }
  _has_bits_.Clear();
  ...
  while (ptr < end) {
    ...
    switch (tag >> 3) {
      ...
      case 14: {
        ...
        msg->set_from_length(::google::protobuf::io::UnalignedLoad<::google::protobuf::uint32>(ptr));
      ...
      case 16: {
        ...
        msg->set_to_length(::google::protobuf::io::UnalignedLoad<::google::protobuf::uint32>(ptr));
        ptr += sizeof(::google::protobuf::uint32);
        break;
      }
      ...
      case 18: {
        ...
        msg->set_depth(::google::protobuf::io::UnalignedLoad<::google::protobuf::uint32>(ptr));
        ptr += sizeof(::google::protobuf::uint32);
        break;
      }
      ...
      case 24: {
        ...
        ptr = ::google::protobuf::io::ReadSize(ptr, &size);
        GOOGLE_PROTOBUF_PARSER_ASSERT(ptr);
        ctx->extra_parse_data().SetFieldName("Header.long_prefix");
        object = msg->mutable_long_prefix();
        if (size > end - ptr + ::google::protobuf::internal::ParseContext::kSlopBytes) {
          parser_till_end = ::google::protobuf::internal::GreedyStringParserUTF8Verify;
          goto string_till_end;
        }
      ...
      case 46: {
        ...
        msg->set_original_from(::google::protobuf::internal::ReadVarint(&ptr));
        GOOGLE_PROTOBUF_PARSER_ASSERT(ptr);
        break;
      }
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 24: {
        if (static_cast< ::google::protobuf::uint8>(tag) == (194 & 0xFF)) {
          DO_(::google::protobuf::internal::WireFormatLite::ReadString(
                input, this->mutable_long_prefix()));
          ::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
            this->long_prefix().data(), static_cast<int>(this->long_prefix().length()),
            ::google::protobuf::internal::WireFormat::PARSE,
            "Header.long_prefix");
        } else {
          goto handle_unusual;
      ...
      case 46: {
        if (static_cast< ::google::protobuf::uint8>(tag) == (368 & 0xFF)) {
          HasBitSetters::set_has_original_from(this);
          DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
                   ::google::protobuf::uint64, ::google::protobuf::internal::WireFormatLite::TYPE_UINT64>(
                 input, &original_from_)));
        } else {
          goto handle_unusual;
        }
        break;
...
void Header::SerializeWithCachedSizes(
  ...
  if (cached_has_bits & 0x00000400u) {
    ::google::protobuf::internal::WireFormatLite::WriteFixed32(14, this->from_length(), output);
  }
  ...
  if (cached_has_bits & 0x00000800u) {
    ::google::protobuf::internal::WireFormatLite::WriteFixed32(16, this->to_length(), output);
  }
  ...
  if (cached_has_bits & 0x00001000u) {
    ::google::protobuf::internal::WireFormatLite::WriteFixed32(18, this->depth(), output);
  }
  ...
  if (cached_has_bits & 0x00020000u) {
    ::google::protobuf::internal::WireFormatLite::WriteUInt64(46, this->original_from(), output);
  }
...
::google::protobuf::uint8* Header::InternalSerializeWithCachedSizesToArray(
  ...
  // optional fixed32 from_length = 14;
  if (cached_has_bits & 0x00000400u) {
    target = ::google::protobuf::internal::WireFormatLite::WriteFixed32ToArray(14, this->from_length(), target);
  }
  ...
  // optional fixed32 to_length = 16;
  if (cached_has_bits & 0x00000800u) {
    target = ::google::protobuf::internal::WireFormatLite::WriteFixed32ToArray(16, this->to_length(), target);
  }
  ...
  // optional fixed32 depth = 18;
  if (cached_has_bits & 0x00001000u) {
    target = ::google::protobuf::internal::WireFormatLite::WriteFixed32ToArray(18, this->depth(), target);
  }
  ...
  // optional uint64 original_from = 46;
  if (cached_has_bits & 0x00020000u) {
    target = ::google::protobuf::internal::WireFormatLite::WriteUInt64ToArray(46, this->original_from(), target);
  }
...
// @@protoc_insertion_point(message_byte_size_start:Header)
  ...
  if (((_has_bits_[0] & 0x00040300) ^ 0x00040300) == 0) {  // All required fields are present.
    // required uint64 from = 2;
    total_size += 1 +
      ::google::protobuf::internal::WireFormatLite::UInt64Size(
        this->from());
...
// @@protoc_insertion_point(class_specific_merge_from_start:Header)
  ...
  if (cached_has_bits & 0x000f0000u) {
    ...
    if (cached_has_bits & 0x00020000u) {
      original_from_ = from.original_from_;
    }
    if (cached_has_bits & 0x00040000u) {
      type_ = from.type_;
    }
...
bool Header::IsInitialized() const {
  if ((_has_bits_[0] & 0x00040300) != 0x00040300) return false;
...
void Header::InternalSwap(Header* other) {
  ...
  callback_rpc_.Swap(&other->callback_rpc_, &::google::protobuf::internal::GetEmptyStringAlreadyInited(),
    GetArenaNoVirtual());
  long_prefix_.Swap(&other->long_prefix_, &::google::protobuf::internal::GetEmptyStringAlreadyInited(),
    GetArenaNoVirtual());
  ...
  swap(original_from_, other->original_from_);
