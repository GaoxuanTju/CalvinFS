...
class LogReaderStateDefaultTypeInternal {
 public:
  ::google::protobuf::internal::ExplicitlyConstructed<LogReaderState> _instance;
} _LogReaderState_default_instance_;
static void InitDefaultsLogReaderState_log_5freader_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::_LogReaderState_default_instance_;
    new (ptr) ::LogReaderState();
    ::google::protobuf::internal::OnShutdownDestroyMessage(ptr);
  }
  ::LogReaderState::InitAsDefaultInstance();
}

::google::protobuf::internal::SCCInfo<0> scc_info_LogReaderState_log_5freader_2eproto =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 0, InitDefaultsLogReaderState_log_5freader_2eproto}, {}};

void InitDefaults_log_5freader_2eproto() {
  ::google::protobuf::internal::InitSCC(&scc_info_LogReaderState_log_5freader_2eproto.base);
}

::google::protobuf::Metadata file_level_metadata_log_5freader_2eproto[1];
constexpr ::google::protobuf::EnumDescriptor const** file_level_enum_descriptors_log_5freader_2eproto = nullptr;
constexpr ::google::protobuf::ServiceDescriptor const** file_level_service_descriptors_log_5freader_2eproto = nullptr;

const ::google::protobuf::uint32 TableStruct_log_5freader_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  PROTOBUF_FIELD_OFFSET(::LogReaderState, _has_bits_),
  PROTOBUF_FIELD_OFFSET(::LogReaderState, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::LogReaderState, started_),
  PROTOBUF_FIELD_OFFSET(::LogReaderState, version_),
  PROTOBUF_FIELD_OFFSET(::LogReaderState, entry_),
  PROTOBUF_FIELD_OFFSET(::LogReaderState, success_),
  2,
  1,
  0,
  3,
...
::google::protobuf::internal::AssignDescriptorsTable assign_descriptors_table_log_5freader_2eproto = {
  {}, AddDescriptors_log_5freader_2eproto, "log_reader.proto", schemas,
  file_default_instances, TableStruct_log_5freader_2eproto::offsets,
  file_level_metadata_log_5freader_2eproto, 1, file_level_enum_descriptors_log_5freader_2eproto, file_level_service_descriptors_log_5freader_2eproto,
};

const char descriptor_table_protodef_log_5freader_2eproto[] =
  ...
  ;
::google::protobuf::internal::DescriptorTable descriptor_table_log_5freader_2eproto = {
  false, InitDefaults_log_5freader_2eproto, 
  descriptor_table_protodef_log_5freader_2eproto,
  "log_reader.proto", &assign_descriptors_table_log_5freader_2eproto, 116,
};
...
void AddDescriptors_log_5freader_2eproto() {
 ...
 ::google::protobuf::internal::AddDescriptors(&descriptor_table_log_5freader_2eproto, deps, 0);
}

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_log_5freader_2eproto = []() { AddDescriptors_log_5freader_2eproto(); return true; }();

// ===================================================================

void LogReaderState::InitAsDefaultInstance() {
}
class LogReaderState::HasBitSetters {
 public:
  static void set_has_started(LogReaderState* msg) {
    msg->_has_bits_[0] |= 0x00000004u;
  }
  static void set_has_version(LogReaderState* msg) {
    msg->_has_bits_[0] |= 0x00000002u;
  }
  static void set_has_entry(LogReaderState* msg) {
    msg->_has_bits_[0] |= 0x00000001u;
  }
  static void set_has_success(LogReaderState* msg) {
...
void LogReaderState::SharedCtor() {
  ::google::protobuf::internal::InitSCC(
      &scc_info_LogReaderState_log_5freader_2eproto.base);
  entry_.UnsafeSetDefault(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
...
// @@protoc_insertion_point(message_clear_start:LogReaderState)
  ...
  if (cached_has_bits & 0x00000001u) {
    entry_.ClearNonDefaultToEmptyNoArena();
  }
...
const char* LogReaderState::_InternalParse(const char* begin, const char* end, void* object,
                  ::google::protobuf::internal::ParseContext* ctx) {
  auto msg = static_cast<LogReaderState*>(object);
...
// @@protoc_insertion_point(generalized_merge_from_start:LogReaderState)
  ...
  const LogReaderState* source =
      ::google::protobuf::DynamicCastToGenerated<LogReaderState>(
          &from);
  if (source == nullptr) {
...
::google::protobuf::Metadata LogReaderState::GetMetadata() const {
  ::google::protobuf::internal::AssignDescriptors(&::assign_descriptors_table_log_5freader_2eproto);
  return ::file_level_metadata_log_5freader_2eproto[kIndexInFileMessages];
}
...
namespace google {
namespace protobuf {
template<> PROTOBUF_NOINLINE ::LogReaderState* Arena::CreateMaybeMessage< ::LogReaderState >(Arena* arena) {
  return Arena::CreateInternal< ::LogReaderState >(arena);
}
}  // namespace protobuf
}  // namespace google
